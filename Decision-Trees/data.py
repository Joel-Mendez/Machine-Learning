...
class Data:
	...
	def __init__(self, fpath = "", data = None,concatenate = 0, oldData = None):
		...
		self.column_index_dict = self._load_data(fpath, data,concatenate,oldData)

	def _load_data(self, fpath = "", data = None, concatenate = 0, oldData = None):
